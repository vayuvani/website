        ...
        <div className="card-container">
          <div className="card">
            ...
            <p>
              ...
              meaning <i>Air</i>, and "<b>Vaani</b>" (वाणी) meaning <i>Voice</i>.
              This name embodies our mission: to give voice to signals traveling
          ...
          <div className="card">
            ...
            <p>
              We're dedicated to providing tools for self-managed,
              offline satellite communication while nurturing a supportive
              community of enthusiasts.
            </p>
          </div>

          <div className="card">
            <h3>How We're Different from <a href="https://tinygs.com/"
                                            target="_blank"
                                            rel="noopener noreferrer">TinyGS</a>
            </h3>
            <p>
              While TinyGS is an excellent project that has paved the way for
              many in LoRa-based satellite reception, VayuVani takes a different
              approach. We focus on:
            </p>
            <ul>
              <li><b>Autonomy:</b> Complete control over your station</li>
              <li><b>Privacy:</b> Operate without relying on external servers
              </li>
              <li><b>Flexibility:</b> Choose your satellites or let VayuVani
                auto-tune
              </li>
              <li><b>Simplicity:</b> Easy setup and operation for all skill
                levels
              </li>
            </ul>
            <p>
              We don't aim to replace TinyGS, but rather to offer an alternative
              for those seeking more independence in their operations.
            </p>
          </div>
